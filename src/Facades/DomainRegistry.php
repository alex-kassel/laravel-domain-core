 ...
 * @method static bool hasStorageContext(string $domainSlug, string $contextSlug = 'default')
 * @method static StorageContext getStorageContext(string $domainSlug, string $contextSlug = 'default')
